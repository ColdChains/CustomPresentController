...
- (IBAction)button1Action:(id)sender {
    ...
    LCNavigationController *nav = [[LCNavigationController alloc] initWithRootViewController:pvc];
...
//    pvc.defaultHeight = LCCustomPresentHeightMiddle;
    ...
    // QLPageController的使用详见：https://github.com/ColdChains/QLPageController.git
}
